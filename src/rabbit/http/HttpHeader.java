 ...
 */
public class HttpHeader extends GeneralHeader implements Cloneable {    
    ...
    public HttpHeader clone() {
    	...
    	this.copyHeader(clone);
    	clone.content = (content != null) ? content.clone() : null;
    	clone.hashCodeValue = hashCodeValue;
